...
export default function AuthDiagnosticsPage() {
  ...
  return <main className="min-h-screen bg-background px-5 py-10">
    ...
    <p className="text-sm">Local, token-free evidence. Validation events describe HTTP outcomes, not token acceptance. Session flags reflect the last observed SDK state. Browser hints cannot identify every embedded browser.</p>
