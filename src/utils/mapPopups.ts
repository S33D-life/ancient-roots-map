...
export function buildPopupHtml(
  ...
  const html = `<div style="padding:0;font-family:'Cinzel',serif;width:240px;background:hsl(30,15%,10%);border-radius:12px;border:1px solid hsla(42,40%,30%,0.4);overflow:hidden;animation:popIn .2s ease-out;">
    ...
    <div style="padding:0 14px 10px;display:flex;gap:6px;">
      ...
      <a href="/tree/${encodeURIComponent(tree.id)}" style="flex:1;display:flex;align-items:center;justify-content:center;padding:8px 0;font-size:11px;color:hsl(80,20%,8%);background:linear-gradient(135deg,hsl(42,88%,50%),hsl(45,100%,60%));border-radius:8px;text-decoration:none;letter-spacing:0.04em;font-weight:700;font-family:sans-serif;">Meet This Tree ⟶</a>
    </div>
    <div style="padding:0 14px 12px;display:flex;gap:4px;justify-content:center;">
      <a href="/tree/${encodeURIComponent(tree.id)}?add=photo" style="display:inline-flex;align-items:center;justify-content:center;gap:3px;flex:1;height:32px;font-size:10px;text-decoration:none;color:hsl(120,25%,65%);background:hsla(120,30%,30%,0.15);border:1px solid hsla(120,40%,40%,0.2);border-radius:8px;font-family:sans-serif;" title="Add Photo">📷 Photo</a>
      <a href="/tree/${encodeURIComponent(tree.id)}?add=song" style="display:inline-flex;align-items:center;justify-content:center;gap:3px;flex:1;height:32px;font-size:10px;text-decoration:none;color:hsl(200,30%,65%);background:hsla(200,30%,30%,0.15);border:1px solid hsla(200,40%,40%,0.2);border-radius:8px;font-family:sans-serif;" title="Add Song">🎵 Song</a>
      <a href="/tree/${encodeURIComponent(tree.id)}?add=birdsong" style="display:inline-flex;align-items:center;justify-content:center;gap:3px;flex:1;height:32px;font-size:10px;text-decoration:none;color:hsl(180,30%,65%);background:hsla(180,30%,30%,0.15);border:1px solid hsla(180,40%,40%,0.2);border-radius:8px;font-family:sans-serif;" title="Record Birdsong">🐦 Birdsong</a>
      <button data-share-tree="${encodeURIComponent(tree.id)}" style="display:inline-flex;align-items:center;justify-content:center;gap:3px;flex:1;height:32px;font-size:10px;background:hsla(42,30%,30%,0.15);border:1px solid hsla(42,40%,40%,0.2);border-radius:8px;cursor:pointer;color:hsl(42,40%,65%);font-family:sans-serif;" title="Share tree link">↗️ Share</button>
    </div>
  </div>`;
