...
export interface RoadmapFeature {
  ...
  symbol?: string;
  /** In-app route for live features */
  route?: string;
}
...
export const ROADMAP_FEATURES: RoadmapFeature[] = [
  // ═══════════════════════════════════════
  // ANCIENT — Mature pillars
  // ═══════════════════════════════════════
  { id: "map",           name: "Ancient Friends Map",       description: "Interactive global map of ancient and remarkable trees — the first prototype and heart of the platform.",                        stage: "ancient", status: "live",     region: "roots",    category: "ancient-friends", connections: ["hives", "hearts"],        row: 0, col: 1,  symbol: "🗺️", route: "/map" },
  { id: "council",       name: "Council of Life",           description: "Community governance gatherings for ecological decision-making. Initiated in the earliest S33D sessions.",                     stage: "rooted",  status: "live",     region: "canopy",   category: "council-of-life", connections: ["hearts", "offerings"],    row: 6, col: 1,  symbol: "🏛️", route: "/council-of-life" },
  ...
  // SPROUT — Building now
  // ═══════════════════════════════════════
  { id: "staff-room",    name: "Staff Room Patron Launch",  description: "First 36 handcrafted staffs and the initial patrons of the Ancient Friends world.",                                           stage: "sprout",  status: "building", region: "trunk",    category: "library",         connections: ["library"],                row: 4, col: 3,  symbol: "🪄", route: "/library/staff-room" },
  { id: "add-tree",      name: "Map Expansion",             description: "Community-driven tree mapping with GPS, photos, and species tagging — expanding the atlas worldwide.",                        stage: "rooted",  status: "live",     region: "roots",    category: "ancient-friends", connections: ["map", "hearts"],          row: 1, col: 2,  symbol: "📍", route: "/add-tree" },
  { id: "tree-detail",   name: "Tree Profiles",             description: "Rich detail pages for every mapped tree with photos, history, offerings, and community data.",                                stage: "rooted",  status: "live",     region: "roots",    category: "ancient-friends", connections: ["map", "offerings"],       row: 1, col: 0,  symbol: "🌲", route: "/map" },
  ...
  { id: "bio-regions",   name: "Bio-Regions Atlas",         description: "Ecological region portals with seasonal calendars and species data.",                                                         stage: "rooted",  status: "live",     region: "roots",    category: "ancient-friends", connections: ["map", "calendar"],        row: 2, col: 1,  symbol: "🌍", route: "/atlas" },

  // ═══════════════════════════════════════
  // GROWTH — Active systems
  // ═══════════════════════════════════════
  { id: "hearts",        name: "S33D Hearts",               description: "Living reward currency earned through ecological participation. The lifeblood of the ecosystem.",                             stage: "rooted",  status: "live",     region: "mycelium", category: "golden-dream",    connections: ["offerings", "council"],   row: 8, col: 1,  symbol: "❤️", route: "/value-tree" },
  { id: "hives",         name: "Species Hives",             description: "Species-based community clusters with honeycomb visualisation and Species Hearts.",                                           stage: "rooted",  status: "live",     region: "canopy",   category: "ancient-friends", connections: ["map", "council"],         row: 6, col: 3,  symbol: "🐝", route: "/hives" },
  { id: "offerings",     name: "Offerings",                 description: "Creative gifts to trees: songs, stories, photos, birdsong recordings.",                                                      stage: "rooted",  status: "live",     region: "mycelium", category: "ancient-friends", connections: ["hearts", "tree-detail"],  row: 8, col: 3,  symbol: "🎁", route: "/map" },
  { id: "library",       name: "Heartwood Library",         description: "Shared knowledge hub: books, wisdom scrolls, music room, and species research.",                                             stage: "rooted",  status: "live",     region: "trunk",    category: "library",         connections: ["offerings", "wisdom"],    row: 4, col: 1,  symbol: "📚", route: "/library" },
  ...
  { id: "harvest",       name: "Harvest Marketplace",       description: "Guardian-managed exchange for seasonal tree produce and seeds.",                                                              stage: "rooted",  status: "live",     region: "roots",    category: "ancient-friends", connections: ["map", "calendar"],        row: 3, col: 0,  symbol: "🍎", route: "/harvest" },

  // ═══════════════════════════════════════
  // CANOPY — Vision & future
  // ═══════════════════════════════════════
  ...
  { id: "calendar",      name: "Cosmic Calendar",           description: "Multi-lens temporal navigation: Gregorian, lunar, indigenous, ecological.",                                                   stage: "rooted",  status: "live",     region: "mycelium", category: "golden-dream",    connections: ["bio-regions"],            row: 10, col: 1, symbol: "🌙", route: "/cosmic" },
  ...
  { id: "wisdom",        name: "Wisdom of the Grove",       description: "Daily rotating quotes and ecological reflections.",                                                                           stage: "rooted",  status: "live",     region: "trunk",    category: "library",         connections: ["library"],                row: 4, col: 3,  route: "/library" },
  { id: "bookshelf",     name: "Personal Bookshelves",      description: "Curate your own reading collection linked to trees and councils.",                                                            stage: "rooted",  status: "live",     region: "trunk",    category: "library",         connections: ["library"],                row: 5, col: 0,  route: "/library" },
  ...
  { id: "groves",        name: "Living Groves",             description: "Clustered tree communities that breathe and pulse on the map.",                                                               stage: "rooted",  status: "live",     region: "roots",    category: "ancient-friends", connections: ["map"],                    row: 3, col: 4,  route: "/groves" },
