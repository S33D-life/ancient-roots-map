  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-[9999] h-11 w-11 rounded-full bg-red-600 text-white shadow-lg flex items-center justify-center hover:bg-red-700 transition-colors"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-16 right-4 z-[9999] w-[380px] max-h-[70vh] overflow-hidden rounded-xl border border-red-500/30 bg-card shadow-2xl"
          >
            {/* Header */}
