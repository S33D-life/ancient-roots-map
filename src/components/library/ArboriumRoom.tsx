  ...
  return (
    <div className="space-y-10 pb-16">
      ...
      <motion.section
        ...
        className="relative rounded-3xl overflow-hidden border border-amber-900/14 dark:border-amber-200/10 px-6 py-8 md:px-10 md:py-10
          bg-[linear-gradient(160deg,hsl(48_55%_95%)_0%,hsl(72_35%_92%)_55%,hsl(95_30%_90%)_100%)]
          dark:bg-[linear-gradient(160deg,hsl(95_18%_11%)_0%,hsl(80_16%_13%)_55%,hsl(95_20%_10%)_100%)]
          shadow-[inset_0_1px_0_hsl(48_45%_98%),0_10px_32px_-20px_hsl(95_35%_25%/0.32)]
          dark:shadow-[inset_0_1px_0_hsl(48_30%_22%/0.35),0_10px_36px_-18px_hsl(0_0%_0%/0.6)]"
      >
        {/* sun motif */}
        <div
          className="absolute -top-14 -right-14 w-56 h-56 rounded-full opacity-45 dark:opacity-30 blur-3xl pointer-events-none
            bg-[hsl(48_80%_70%/0.55)] dark:bg-[hsl(42_70%_45%/0.4)]"
          aria-hidden
        />
        {/* pressed-leaf pattern */}
        <div
          className="absolute inset-0 opacity-[0.055] dark:opacity-[0.07] pointer-events-none mix-blend-multiply dark:mix-blend-screen"
          style={{
            backgroundImage:
        ...
        <div className="relative max-w-2xl">
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-amber-900/20 dark:border-amber-300/20 bg-[hsl(48_55%_96%)]/70 dark:bg-[hsl(80_18%_15%)]/70 text-[10px] font-serif uppercase tracking-[0.2em] text-amber-900/68 dark:text-amber-200/75">
