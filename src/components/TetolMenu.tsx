...
import { Sprout, Heart, TreeDeciduous, Sparkles, Crown, Leaf, Search, MapPin, BookOpen, BarChart3, Loader2, Hexagon, Apple, CalendarDays, TreePine, Map, Smartphone, Brain } from "lucide-react";
...
const quickLinks = [
  ...
  { to: "/tetol-brain", label: "Second Brain", icon: Brain },
