/**
 * Spiral of Species — Constellation Map
 * A calm, astronomical-style visualization where staffs appear as stars
 * in a forest galaxy, connected by golden spiral threads.
 *
 * Structure:
...
import { Crown, Heart, TreeDeciduous, Sprout, ArrowRight, ChevronLeft, Sparkles, Shield } from "lucide-react";
      ...
      <div className="p-5 sm:p-8 space-y-5">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-[10px] font-serif max-w-md mx-auto leading-relaxed" style={{ color: "hsl(42, 30%, 50%)" }}>
            ...
            species clusters orbiting outward like stars in a forest galaxy.
          </p>
          {globalHearts > 0 && (
            <div className="inline-flex items-center gap-1 text-[9px] font-serif" style={{ color: "hsl(0, 60%, 60%)" }}>
  ...
  return (
    ...
    >
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100">
        ...
        {/* Mycelial threads — center to species clusters */}
        ...
        return (
          <HoverCard key={`star-${staff.code}`} openDelay={80} closeDelay={30}>
              ...
              >
                <Link to={ROUTES.STAFF(staff.code)} className="block relative">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: isHovered ? `${colors.core}` : `${colors.core}60`,
                      boxShadow: isHovered
                  ...
                  >
                    <span
                      ...
                      style={{ color: isHovered ? "hsl(0, 0%, 95%)" : `${colors.core}` }}
                    >
                      {isHovered ? (i + 1) : ""}
                    </span>
                  </div>
            ...
            <HoverCardContent
              side="top"
              sideOffset={12}
              className="w-52 p-3 border-border/50"
              style={{
        ...
        return (
          ...
          >
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-full mt-1.5 pointer-events-none">
              <p
                className="text-[6px] sm:text-[7px] font-serif text-center whitespace-nowrap tracking-[0.15em] uppercase"
