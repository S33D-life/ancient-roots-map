      ...
      const popup = new maplibregl.Popup({
        ...
        <div style="padding: 12px; font-family: 'Cinzel', serif; min-width: 230px;">
          ...
          <div style="margin-top: 8px; display: flex; gap: 8px; justify-content: center;">
            ...
            <a href="/tree/${encodeURIComponent(tree.id)}?add=birdsong" style="display: inline-flex; align-items: center; justify-content: center; width: 36px; height: 36px; font-size: 16px; color: hsl(180, 60%, 50%); text-decoration: none; border: 1px solid hsla(180,60%,50%,0.3); border-radius: 8px; transition: background 0.2s;" title="Record Birdsong">🐦</a>
